...
<template>
  <section>
    <article>
      ...
      <div class="grid">
        <div>
          <input type="file" accept="image/*" id="logo" ref="logoInput" @change=" checkLogo " />
      ...
      <textarea v-model.lazy=" brief " :[invalidKey]=" invalid.brief " @change=" checkBrief " type="text" id="phone"
        placeholder="请介绍一下企业的基本情况" required></textarea>
